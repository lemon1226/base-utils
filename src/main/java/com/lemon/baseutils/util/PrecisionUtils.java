...
/**
 * description: * 数学计算工具类, 避免计算过程中精度丢失，提供常用的数值加减乘除计算 , 及多个数值的求和 , 平均值 , 最大最小值计算
 *
 * @author lemon
 * @date 2019-04-25 18:41:06 创建
 */
public class PrecisionUtils {
     ...
     */
    public static Double add(Double dv1, Double dv2) {
        BigDecimal v1 = new BigDecimal(dv1);
        BigDecimal v2 = new BigDecimal(dv2);
